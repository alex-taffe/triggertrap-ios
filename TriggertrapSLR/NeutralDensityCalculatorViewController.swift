...
class NeutralDensityCalculatorViewController: SplitLayoutViewController, HorizontalPickerDelegate, TTNumberInputDelegate {
    ...
    override func viewDidLoad() {
        ...
        if isEmbedded {
            ...
            leftBarButton.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.preferredFont(forTextStyle: .title2)], for: UIControl.State())
            ...
            rightBarButton.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.preferredFont(forTextStyle: .title2)], for: UIControl.State())
