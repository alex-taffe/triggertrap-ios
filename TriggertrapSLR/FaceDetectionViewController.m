...
- (void)setupFilter; {
    ...
    //route the camera through the saturation filter
    [videoCamera addTarget:saturationFilter];

    //route the saturation filter through the zoom filter
    [saturationFilter addTarget:zoomFilter];
    
    
    GPUImageView *filterView = (GPUImageView *)self.view;
    filterView.fillMode = kGPUImageFillModePreserveAspectRatioAndFill;

    //add the zoom filter to the view
